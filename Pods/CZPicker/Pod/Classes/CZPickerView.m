...
- (UIView *)buildFooterView{
    ...
    cancelButton.titleLabel.font = [UIFont fontWithName:@"Muli" size:20.0];
    ...
    confirmButton.titleLabel.font = [UIFont fontWithName:@"Muli" size:20.0];
...
- (UIView *)buildHeaderView{
    ...
    UIFont *headerFont = self.headerTitleFont == nil ? [UIFont fontWithName:@"Muli" size:18.0] : self.headerTitleFont;
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    cell.textLabel.font = [UIFont fontWithName:@"Muli-Light" size:18.0];
